    ...
    <div className="admin-page">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>关键词检索与混合融合策略配置</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div>
            <h4 className="text-sm font-medium text-slate-700 mb-3">关键词检索 (PG tsquery)</h4>
            <div className="grid gap-4 md:grid-cols-3">
              <InfoItem
                label="Enabled"
                value={<BoolBadge value={rag.channels.keyword.enabled} />}
              />
          ...
          <div>
            <h4 className="text-sm font-medium text-slate-700 mb-3">混合融合策略</h4>
            <div className="grid gap-4 md:grid-cols-3">
              <InfoItem
                label="Enabled"
                value={<BoolBadge value={rag.channels.hybrid.enabled} />}
              />
