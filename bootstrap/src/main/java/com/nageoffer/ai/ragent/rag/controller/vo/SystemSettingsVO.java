...
public class SystemSettingsVO {
    ...
    public static class ChannelSettings {
        private KeywordChannelSettings keyword;
        private HybridChannelSettings hybrid;

        @Data
        @Builder
        public static class KeywordChannelSettings {
            private Boolean enabled;
        ...
        @Data
        @Builder
        public static class HybridChannelSettings {
            private Boolean enabled;
