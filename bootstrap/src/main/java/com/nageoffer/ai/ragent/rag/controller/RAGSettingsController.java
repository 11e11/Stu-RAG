...
public class RAGSettingsController {
    ...
    private ChannelSettings toChannelSettings(SearchChannelProperties props) {
        return ChannelSettings.builder()
                .keyword(ChannelSettings.KeywordChannelSettings.builder()
                        .enabled(props.getChannels().getKeyword().isEnabled())
                        .topKMultiplier(props.getChannels().getKeyword().getTopKMultiplier())
                        .boost(props.getChannels().getKeyword().getBoost())
                        .build())
                .hybrid(ChannelSettings.HybridChannelSettings.builder()
                        .enabled(props.getChannels().getHybrid().isEnabled())
                        .fusion(props.getChannels().getHybrid().getFusion().name())
                        .vectorWeight(props.getChannels().getHybrid().getVectorWeight())
                        .build())
                .build();
    }
